...
Write-Host "===============================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "[1/2] Opening browser to http://127.0.0.1:8001/ ..." -ForegroundColor Green
Start-Process "http://127.0.0.1:8001/"
Write-Host ""
Write-Host "[2/2] Starting Unified Gateway and Cockpit HUD on port 8001..." -ForegroundColor Yellow
Write-Host ""
