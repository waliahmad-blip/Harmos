...
Write-Host "===============================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "[1/2] Opening browser to http://127.0.0.1:8002/ ..." -ForegroundColor Green
Start-Process "http://127.0.0.1:8002/"
Write-Host ""
Write-Host "[2/2] Starting Unified Gateway and Cockpit HUD on port 8002..." -ForegroundColor Yellow
Write-Host ""
